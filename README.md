...
1. uv: uv is all-in-one Python package and project manager Follow the instructions on the website to install uv based on your machine [uv](https://docs.astral.sh/uv/getting-started/installation/) 

2. Free Gemini API key from [Google AI Studio](https://aistudio.google.com/apikey).
